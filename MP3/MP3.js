...
* @param {int} target Which side of the cubemap to place the image on
* @param {texture} texture Cubemap to add the texture to
* @param {string} url Filepath indicating where the image to be loaded is stored
* @return None
*/
...
* @param {image} image Image to be added to side
* @param {texture} Cubemap to add image to
* @return None
*/
